...
public class Main {
    public static void main(String[] args) {
        ...
        hotBox.addProductToBox(new HotDrinks("Capuccino", 0.25, 120.25));
        hotBox.addProductToBox(new HotDrinks("Americano Expresso", 0.25, 110.5));
        hotBox.addProductToBox(new HotDrinks("Hot chocolate", 0.25, 90));
